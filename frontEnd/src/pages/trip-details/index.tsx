import { MapPin, Calendar, Plus, Settings2, CircleCheck, Link2, CircleDashed, UserCog, X, Tag, Clock, User, Mail } from "lucide-react";
                ...
                <div className="w-80 space-y-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-5">
                            ...
                            <button onClick={openConfirmeInviteModal} className="bg-zinc-800 text-zinc-200 flex items-center justify-center gap-2 px-5 py-2 rounded-lg font-medium hover:bg-zinc-700 w-full h-11">
                                <UserCog className=""/>
