import { Plus, CircleCheck, CircleDashed, Trash, Pencil, Check, X } from "lucide-react";
                                    ...
                                    information.activities.map((activity) => {
                                        return (
                                            <div key={activity.id} className="flex justify-between items-center gap-3 h-12 px-4 rounded-xl bg-zinc-900 text-zinc-100 shadow-shape">
                                                ...
                                                <Button colors="primary" size="default" onClick={openUpdateModal}>
                                                ...
                                                {isUpdateModalOpen && (
                                                    <div className="bg-black">
                                                        <div className="">
                                                            <Button colors="secundary" onClick={closeUpdateModal}>
                                                                <X className="size-5"/>
                                                            </Button>
                                                        </div>
